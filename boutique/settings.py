...
if 'USE_AWS' in os.environ:
    # Cache control. This will tell the browser that it's okay to
    # cache static files for a long time since they don't change
    # very often, and this will improve performance for our users.
